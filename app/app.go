...
import (
	...
	tokenappparams "github.com/notional-labs/token-factory/app/params"
	"github.com/notional-labs/token-factory/x/tokenfactory"
	"github.com/notional-labs/token-factory/x/tokenfactory/bindings"
	tokenfactorykeeper "github.com/notional-labs/token-factory/x/tokenfactory/keeper"
	tokenfactorytypes "github.com/notional-labs/token-factory/x/tokenfactory/types"

	// unnamed import of statik for swagger UI support
	_ "github.com/cosmos/cosmos-sdk/client/docs/statik"
)

const appName = "TokenApp"
...
func NewWasmApp(
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig tokenappparams.EncodingConfig,
	...
	icaControllerIBCModule := icacontroller.NewIBCMiddleware(transferIBCModule, app.ICAControllerKeeper)
...
func (app *TokenApp) ModuleManager() module.Manager {
	return *app.mm
}

// ModuleConfigurator returns instance
func (app *TokenApp) ModuleConfigurator() module.Configurator {
...
func (app *TokenApp) ModuleAccountAddrs() map[string]bool {
